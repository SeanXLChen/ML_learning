...
This test file is for ionosphere dataset testing.
"""
...
base_model.plot_roc_curve(X_test_base, y_test_base).show()
base_model.plot_precision_recall_curve(X_test_base, y_test_base).show()
